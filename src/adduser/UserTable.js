...
function UserTable() {
  ...
  const fetchData = async () => {
    try {
      const response = await AxiosInstance.get("/savaj_user/SavajCapital_User", {
        params: {
          page: currentPage,
          limit: itemsPerPage,
  ...
  <img
    ...
    alt="User Image"
    style={{ width: "50px", height: "50px", borderRadius: "50%" }} // adjust the size and style as per your need
  />
</Td>
